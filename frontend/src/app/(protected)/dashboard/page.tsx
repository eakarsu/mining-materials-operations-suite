...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Mining Materials Operations Dashboard"
      subtitle="One merged mining materials operations view for Sites, Equipment, Production, Haulage, Safety, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared mining materials operations jobs into one surface. Sites, Equipment, Production, Haulage, Safety, Permits, documents, audit, and AI are presented as platform features.</div>
