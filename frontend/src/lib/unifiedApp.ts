...
const features = [
  ...
  {
    slug: "exploration-targets",
    title: "Exploration Targets",
    href: "/exploration-targets",
    category: "Mineral Exploration Geology",
    icon: Workflow,
    summary: "Exploration Targets elevated from the Mineral Exploration Geology source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Exploration Targets queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Exploration Targets", value: "24", note: 'Active' },
      { label: 'Review', value: "4", note: 'Needs attention' },
      { label: 'Due Soon', value: "3", note: 'Next 14 days' },
    ],
  },
  {
    slug: "geology-sample-review",
    title: "Geology Sample Review",
    href: "/geology-sample-review",
    category: "Mineral Exploration Geology",
    icon: Workflow,
    summary: "Geology Sample Review elevated from the Mineral Exploration Geology source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Geology Sample Review queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Geology Sample Review", value: "33", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "mineral-prospect-risk",
    title: "Mineral Prospect Risk",
    href: "/mineral-prospect-risk",
    category: "Mineral Exploration Geology",
    icon: Workflow,
    summary: "Mineral Prospect Risk elevated from the Mineral Exploration Geology source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Mineral Prospect Risk queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Mineral Prospect Risk", value: "42", note: 'Active' },
...
export const featureFamilies = [
  ...
  { name: 'Mineral Exploration Geology', features: ["Exploration Targets","Geology Sample Review","Mineral Prospect Risk"] },
