...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Sites Packet', type: 'Sites', owner: 'Operations Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Equipment Review Bundle', type: 'Equipment', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Production Evidence Set', type: 'Production', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
