...
const featureSeeds = [
  ['sites', 'Sites', 'Sites operating queue', 'Operations Lead', 'Review and assign next action'],
  ['equipment', 'Equipment', 'Equipment operating queue', 'Operations Lead', 'Review and assign next action'],
  ['production', 'Production', 'Production operating queue', 'Operations Lead', 'Review and assign next action'],
  ['haulage', 'Haulage', 'Haulage operating queue', 'Operations Lead', 'Review and assign next action'],
  ['safety', 'Safety', 'Safety operating queue', 'Operations Lead', 'Review and assign next action'],
  ['permits', 'Permits', 'Permits operating queue', 'Operations Lead', 'Review and assign next action'],
  ['maintenance', 'Maintenance', 'Maintenance operating queue', 'Operations Lead', 'Review and assign next action'],
  ['blending', 'Blending', 'Blending operating queue', 'Operations Lead', 'Review and assign next action'],
  ['inventory', 'Inventory', 'Inventory operating queue', 'Governance Lead', 'Review and assign next action'],
  ['exploration', 'Exploration', 'Exploration operating queue', 'Governance Lead', 'Review and assign next action'],
  ['environmental', 'Environmental', 'Environmental operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ['reports', 'Reports', 'Reports operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ["exploration-targets","Exploration Targets","Exploration Targets review queue","Mineral Exploration Geology","Review source context and assign owner"],
  ["geology-sample-review","Geology Sample Review","Geology Sample Review review queue","Mineral Exploration Geology","Confirm next action and update evidence"],
  ["mineral-prospect-risk","Mineral Prospect Risk","Mineral Prospect Risk review queue","Mineral Exploration Geology","Confirm next action and update evidence"],
