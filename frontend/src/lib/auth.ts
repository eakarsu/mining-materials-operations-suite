export const AUTH_COOKIE = 'mining_materials_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@mining-materials.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@mining-materials.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@mining-materials.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
