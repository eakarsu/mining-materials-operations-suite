...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Sites alert', detail: 'Sites queue needs review.', read: false },
  { id: 'note-2', title: 'Equipment approval due', detail: 'Equipment exception list needs approval.', read: false },
  { id: 'note-3', title: 'Production updated', detail: 'Production operating queue was refreshed.', read: true },
];
