...
PORT="${PORT:-4670}"
DB_NAME="${PGDATABASE:-mining_materials_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Mining Materials Operations Suite"
echo "======================================="
echo
...
echo "Starting mining materials operations suite frontend on http://localhost:$PORT"
echo "Login: admin@mining-materials.local / admin123"
